...
export default function ProblemCard({ problem, solution, color }) {
  return (
    <div className="bg-gray-800 border border-gray-700 rounded-xl p-8 hover:border-cyan-400 hover:shadow-lg hover:shadow-cyan-400/30 transition group cursor-pointer relative overflow-hidden">
      ...
      <div className={`w-12 h-12 bg-gradient-to-br ${color} rounded-lg mb-4 shadow-lg group-hover:shadow-xl transition`} />
      <h3 className="text-2xl font-bold text-white mb-3 group-hover:text-cyan-400 transition">{problem}</h3>
